...
<div>
  ...
  <div class="flex-panel">
    <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-for="(item,index) in labs.list" :key="index">
    ...
    <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-if="labs.totalCount===0">
        <div>
