<template>
  <div>
    ...
    <div class="flex-panel">
      <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-for="(item,index) in departments.list" :key="index">
      ...
      <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-if="departments.totalCount===0">
        <div>
