<template>
  <div>
    ...
    <div class="flex-panel">
      <Card :class="{'modelCard':$store.state.modal}"   v-for="(item,index) in departments.list" :key="index">
      ...
      <Card :class="{'modelCard':$store.state.modal}"   v-if="departments.totalCount===0">
        <div>
