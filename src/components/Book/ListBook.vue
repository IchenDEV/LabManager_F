<template>
  <div>
    ...
    <div class="flex-panel">
      <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-for="(item,index) in books.list" :key="index">
      ...
      <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-if="books.totalCount===0">
