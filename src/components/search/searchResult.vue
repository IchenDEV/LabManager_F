<template>
  <div>
    <div class="flex-panel">
      <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-for="(item,index) in data.info.list" :key="index">
        <div>
      ...
      <Card :class="{'modelCard':$store.state.modal}" :bordered="false"  v-if="data.info.totalCount===0">
